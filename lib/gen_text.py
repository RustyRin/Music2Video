...
def artist(text, color='white', method='caption', font_size=None, resolution=(0,0), align='north-west', debug_mode=False):
    if font_size == None:
...
def album(text, color='white', method='caption', resolution=(0,0), make_4k=True, align='north-west', debug_mode=False):
...
def track(text, color='white', method='caption', font_size=None, resolution=(0,0), box_size=None, make_4k=True, align='north-west', debug_mode=False):
    if font_size == None:
